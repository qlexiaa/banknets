...
first-stage regression under the same panel as panel_fe_credit.py:
...
Equations follow the notation in the thesis methods section.
...
def build_sample(panel_sub, county_order, W_geo_all, W_bank_all, YEARS, year_pos):
    """
    Build within-transformed arrays for one sample (full or non-border).
