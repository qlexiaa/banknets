...
def run(output_dir=None):
    ...
    for k in K_VALUES:
        ...
        y_nb, x_nb, w_knn_nb, N_nb = build_arrays(
            panel_nb, county_order, W_knn_all, YEARS, year_pos, "NB")
        res_nb = run_fe(y_nb, x_nb, w_knn_nb, f"W_bank_k{k}", "NB", YEARS)
        ...
        sweep_rows.append(dict(
            ...
            n_co            = N_f,
            n_obs           = N_f  * T,
            lam_geo_nb      = LAM_GEO_NB,
            lam_bank_knn_nb = lam_nb,
            gap_nb          = lam_nb - LAM_GEO_NB,
            n_co_nb         = N_nb,
            n_obs_nb        = N_nb * T,
        ))
    ...
    print(f"Crossover k: full={cf}  non-border={cnb}")
    print("=" * W)
