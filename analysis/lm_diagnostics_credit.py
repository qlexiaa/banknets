...
Dl_nloans_b under W_geo and W_bank, for full and non-border samples.

Mean specification matches panel_fe_credit.py:
...
def run(output_dir=None):
    ...
    print("=" * width)
    print(f"{'Sample':<14} {'W':<8} {'N':>6} "
          f"{'LM-Err':>10} {'p':>8} {'LM-Lag':>10} {'p':>8} "
          f"{'rLM-Err':>10} {'p':>8} {'rLM-Lag':>10} {'p':>8} {'Decision':<13}")
    print("-" * width)
    for r in rows:
        print(f"{r['sample']:<14} {r['w_matrix']:<8} {r['n_counties']:>6} "
