"""
rq1_jtest.py -- Davidson & MacKinnon (1981) J-test for competing spatial weights
=================================================================================
...
def run_pair(panel_sub, county_order, W_null_all, W_alt_all,
    ...
    # Islands in the FULL N×N matrices (same logic as rq1_four_w_comparison.py)
...
def run(output_dir=None):
    ...
    PAIRS = [
        ("W_geo", W_geo_all, "W_bank_bin",   W_bin_all),
        ("W_geo", W_geo_all, "W_bank_count",  W_cnt_all),
        ("W_geo", W_geo_all, "W_bank_nonGeo", W_ng_all),
    ]

    # ── Run all 3 pairs × 2 samples = 6 sets of J-tests ──────────────────────
    rows = []
    ...
    print()
    print("=" * W)
    print("J-test (Davidson & MacKinnon 1981): W_geo vs bank weight matrices")
