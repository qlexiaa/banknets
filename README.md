...
The active pipeline runs, in order: baseline diagnostics, bank Moran diagnostics, bank-geography overlap, LM diagnostics, credit SEM, HPI companion SEM, four-W comparison, non-geographic bank links, KNN sweep, J-tests, composite W sweep, and spatial multiplier decomposition.
